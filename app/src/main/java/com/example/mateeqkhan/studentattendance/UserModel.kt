...
class UserModel {
    ...
    constructor(cursor: Cursor) {
        ...
        dateOfBirth = cursor.getString(cursor.getColumnIndex(DBContract.UserEntry.COLUMN_DATE_OF_BIRTH))
        ...
        semester = cursor.getString(cursor.getColumnIndex(DBContract.UserEntry.COLUMN_SEMESTER))
    ...
    companion object {
        fun userValues(user: UserModel): ContentValues {
            ...
            values.put(DBContract.UserEntry.COLUMN_REGISTER_NUMBER, user.rollnumber)
            values.put(DBContract.UserEntry.COLUMN_DATE_OF_BIRTH, user.dateOfBirth)
            ...
            values.put(DBContract.UserEntry.COLUMN_SEMESTER, user.semester)
...
class UserAttendenceModel {
    ...
    constructor(cursor: Cursor) {
        ...
        dateOfBirth = cursor.getString(cursor.getColumnIndex(DBContract.UserAttendence.COLUMN_DATE_OF_BIRTH))
        ...
        semester = cursor.getString(cursor.getColumnIndex(DBContract.UserAttendence.COLUMN_SEMESTER))
